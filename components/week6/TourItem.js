...
export default function TourItem(props) {
    return (
        <View>
            ...
            <View style={{ marginRight:10,marginTop : -30, height : 30 , width: 200, paddingHorizontal : 10, backgroundColor : 'black', opacity : 0.5, borderBottomLeftRadius : 10 , borderBottomRightRadius : 10 }}>
